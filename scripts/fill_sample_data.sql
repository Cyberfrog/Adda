...
insert into topics(name,description,start_time,email)
	values ("criket","sachin tendulkar",123454,"dolly@ex.com");
insert into comments(content,topic_id,time,email)
	values ("hiiii",1,12345,"dolly@ex.com"),("hello",1,12345,"ankur@ex.com");
update users set start_topic_id =1 where email ='dolly@ex.com';
update users set join_topic_id =1 where email ='ankur@ex.com'; 
